...
<body>
  ...
  ?>
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #EE4266;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <?php if ($level == "Admin") : ?>
            <a class="nav-link nav-item <?= $dash ?>" href="index.php?dashboard">
              <h6><b>Dashboard</b></h6><span class="sr-only"></span>
            </a>
            <div class="nav-item dropdown <?= $us ?><?= $m ?>">
              <h6 class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown"><b>Entri Data</b></h6>
            ...
            <a class="nav-link nav-item <?= $or ?>" href="index.php?order">
              <h6><b>Entri Order</b></h6><span class="sr-only">(current)</span>
            </a>
            <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan">
              <h6><b>Laporan</b></h6> <span class="sr-only">(current)</span>
            </a>
          <?php elseif ($level == "Kasir") : ?>
            <a class="nav-link nav-item <?= $home ?>" href="index.php">
              <h6><b>Home </b></h6><span class="sr-only">(current)</span>
            </a>
            <a class="nav-link nav-item <?= $tran ?>" href="index.php?transaksi">
              <h6><b>Entri Transaksi</h6></b> <span class="sr-only">(current)</span>
            </a>
            <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan">
              <h6><b>Laporan</h6></b> <span class="sr-only">(current)</span>
            </a>
          ...
          <?php else : ?>
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button">
                <img src="assets/image/user.png" alt="user" width="28">
                <?= $_SESSION['level'] ?><span class="mr-1"></span></a>
          ...
          <?php if ($_SESSION['level'] != "owner") : ?>
            <li class="nav-item dropdown">
              <a class="nav-link" data-toggle="modal" data-target=".bd-example-modal-xl">
                <img src="assets/image/keranjang.png" alt="Keranjang" width="30">
                <span>Keranjang</span>
              </a>
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title"><b>Keranjang</b></h3>
            ...
            <div class="row">
              <div class="col-md-4">
                <!-- <div class="form-group">
                  ...
                  <input type="text" readonly name="username" class="form-control" value="username<?= $data; ?>">
                </div> -->
                <div class="form-group">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="fungsi/hapusOrder.php?id=<?= $pesanan['id_dorder'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>Batal</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
