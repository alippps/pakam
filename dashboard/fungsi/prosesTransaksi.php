...
if ($uang < $total_bayar) {
    ...
    if ($query > 0) {
        ...
        <div class="alert alert-success mb-2 alert-dismissible text-small " role="alert">
            <h5 ><b>Berhasil!</b> Transaksi berhasil</h5> <a class="btn btn-sm btn-primary" href="admin/print_struk.php?id_order=' . $id_order . '" target="_blank">Print Struk <i class="fa fa-print"></i></a>
            <button type="button" class="close" data-dismiss    ="alert" aria-label="close"><span aria-hidden="true">&times;</span></button>
        </div>
        ';
        ...
        <div class="alert alert-danger mb-2 alert-dismissible text-small " role="alert">
            <h6><b>Gagal!</b> Transaksi gagal</h6> 
            <button type="button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button>
        </div>
        ';
        header("location:../index.php?transaksi");
