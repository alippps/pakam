    ...
    <div class="card">
        ...
        <div class="card-body">
            <a href="admin/semua_laporan.php" target="_blank" class="btn btn-primary btn-sm mb-3">
                <h6><b>Print semua laporan</b></h6> <i class="fa fa-print"></i>
            </a>
                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="admin/print_struk.php?id_order=<?= $row['id_order'] ?>" target="_blank" class="btn btn-primary text-white btn-sm text-small"><i class="fas fa-print"></i>Print</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
