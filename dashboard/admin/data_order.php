    <div class="container mt-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="index.php?home"><button class="btn btn-primary btn-sm mb-3">
                        <h6><b>Entri Order</b></h6>
                        <style>
                            .card-header {
                                text-align: center;
                            }
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="fungsi/hapusPesan.php?id=<?= $orders['id_order'] ?>" class="btn btn-danger btn-sm text-small" onclick="return confirm('Yakin ingin menghapus data ini ?')">
                                        <i class="fas fa-trash"></i> Batalkan
                                    </a>
                                    <!-- <button type="button" title="Detail Order" class="btn btn-sm btn-secondary text-small text-white" data-toggle="modal" data-target="#detailOrder_<?= $orders['id_order'] ?>"><i class="fas fa-eye"></i>Detail</button> -->
